...
*/
+ (NSImage *)animatedImageWithAnimatedGIFData:(NSData *)theData;
...
*/
+ (NSImage *)animatedImageWithAnimatedGIFURL:(NSURL *)theURL;

+ (NSArray *)framesOfAnimatedImageWithAnimatedGIFData:(NSData *)theData;
